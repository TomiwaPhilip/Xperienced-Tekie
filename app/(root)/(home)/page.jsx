...
// import CurvedLine from "../../../components/shared/CurvedLine";
...
const Home = () => (
  <section>
    ...
    <AnimateContent>
      <div className="text-center mx-auto">
        ...
        <p className="px-6 text-[30px] max-sm:text-[20px] leading-9 flex mx-6 font-[400]">
          Don't go to the real world unprepared! Our goal is to get every Tekie
          to become Xperienced, Bold, and Sharp by building projects that is
          bigger than their capacity.
        </p>
        <br /> <br />
        <Button
          params={"my_btn"}
    ...
    <AnimateContent>
      ...
      <div className="mt-[80px] mx-[4vw]">
        ...
        <p>
          ...
          dolor sit amet consectetur adipisicing elit. Saepe optio ducimus odio
          eos architecto illum, incidunt eveniet, recusandae quia voluptatibus
          dicta assumenda dolorem, deserunt eligendi ea earum! Iste, alias id?
        </p>
    ...
    <div className="mt-[80px] bg-slate-950 p-10">
          <p className="text-center text-white">Website Developed by Xperienced Tekie</p>
    </div>
    </div>
  </section>
);
